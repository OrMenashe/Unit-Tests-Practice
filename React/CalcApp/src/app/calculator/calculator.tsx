  ...
  return (
    <div className={ styles.calculator }>
      ...
      <div className={ styles.calculator__input_group }>
        ...
        <input aria-label="first-input"  type="number" value={firstNumber} onChange={e => setFirstNumber(Number(e.target.value))} className={ styles.calculator__input } />
      </div>

      <div className={ styles.calculator__input_group }>
        <label className={ styles.calculator__label }>Second Number:</label>
        <input aria-label="second-input"  type="number" value={secondNumber} onChange={e => setSecondNumber(Number(e.target.value))} className={ styles.calculator__input } />
      </div>
